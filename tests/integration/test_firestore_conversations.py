...
class TestAppendMessage:
    ...
    def test_append_creates_message_and_header(
    ...
    def test_append_duplicate_message_returns_false(
        self, store, mock_firestore_client
    ):
...
class TestGetMessages:
    ...
    def test_get_messages_returns_page(self, store, mock_firestore_client):
        ...
        with patch.object(
            ...
            "collection",
            return_value=messages_collection
        ):
    ...
    def test_get_messages_with_cursor_pagination(
        self, store, mock_firestore_client
    ):
...
class TestGetHeader:
    ...
    def test_get_header_returns_header_when_exists(
        self, store, mock_firestore_client
    ):
    ...
    def test_get_header_returns_none_when_not_exists(
        self, store, mock_firestore_client
    ):
...
class TestMessageOrdering:
    ...
    def test_get_messages_orders_by_timestamp_desc(
        self, store, mock_firestore_client
    ):
